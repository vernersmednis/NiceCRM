                                        ...
                                        @foreach($companies as $company)
                                            <tr id="company-row-{{ $company->id }}" data-id="{{ $company->id }}" data-token="{{ csrf_token() }}">
                                                ...
                                                <td class="px-4 py-2 border">
                                                    ...
                                                    <button class="bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50">{{ __('Delete') }}</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
